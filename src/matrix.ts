...
export class Matrix4 {
    ...
    public rotate(angle : number, x : number, y : number, z : number) : Matrix4 {
        return this.mulm4(new Matrix4().setRotate(angle, x, y, z));
    };

    public mulm4(other : Matrix4) : Matrix4 {
    ...
    public mulv3(v : Vector3) : Vector3 {
        let e = this.elements;
    ...
    public setLookAt(eyeX : number, eyeY : number, eyeZ : number,
        ...
        let e = this._elements;
        e[0] = s.x;   e[4] = s.y;   e[8] = s.z;    e[12] = 0;
        e[1] = u.x;   e[5] = u.y;   e[9] = u.z;    e[13] = 0;
        e[2] = -f.x;  e[6] = -f.y;  e[10] = -f.z;  e[14] = 0;
        e[3] = 0;     e[7] = 0;     e[11] = 0;     e[15] = 1;
    ...
    public setPerspective(fovy : number, aspect : number, near : number, far : number) {
        ...
        let n = near;
        let f = far;
        e[0] = ct / a; e[4] = 0;   e[8]  = 0;             e[12] = 0;
        e[1] = 0;      e[5] = ct;  e[9]  = 0;             e[13] = 0;
        e[2] = 0;      e[6] = 0;   e[10] = -(f + n) * rd; e[14] = -2 * n * f * rd;
...
export class Vector3 {
    ...
    public normalize() : Vector3 {
        ...
        if(isNaN(d) || d == 0.0) {
            throw new Error("NaN in Normalize, d is " + d);
        } else {
    ...
    public cross(other : Vector3) {
        ...
        let y1 = other.y;
        let z1 = other.z;
        return new Vector3(y0 * z1 - z0 * y1,
                           z0 * x1 - x0 * z1,
                           x0 * y1 - y0 * x1);
    }
}
